...
import { RepositoryType } from '@/gql';
import { Card, Badge, Text, Flex } from '@/components';
import { getRouteRepository } from '@/utils/constants';
...
const RepositoryItem = ({ login, repository }: RepositoryItemProps) => (
    <Card withBorder padding='lg' radius='md' w='100%'>
        ...
        <Flex align='center' gap='3px'>
            ...
            <Link href={getRouteRepository(login, repository.name)} prefetch={false}>
                <Text fw={500} fz='md'>
                    {repository.name}
                </Text>
            </Link>
